...
def pipeline(start, end,filepath):
    ...
    target_data = clean(raw_data, start,end) 
    ...
    clustered_data.to_csv(filepath+docfile)
    ...
    weather_event = find_weather_event(filepath+weafile,lem_data,idx2doc)
