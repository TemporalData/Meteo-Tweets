...
class RegionTopic(models.Model):
    # cluster_idx = models.ForeignKey(
    # Document, related_name=cluster_idx, on_delete=models.CASCADE)
    ...
    # keywords = models.TextField(default=None,blank=True)
    # list of (keyword, prob) by ldamodel.show_topic(11)
